   ...
   <body class="biz  ko" >
      ...
      <app>
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  ...
                  <!---->
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="./bookingLogin" method = "post">
         ...
         <footer  aria-hidden="false">
            <!---->
            <go-to-top >
               <div class="gototop"  aria-hidden="false"> <a href="/bookingLogin" class="lnk_top" > <span class="lnk_top_text" translate="CM-TOP">TOP</span> </a> </div>
            </go-to-top>
            <!----> <!---->
