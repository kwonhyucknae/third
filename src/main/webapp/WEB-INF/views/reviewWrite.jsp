...
<html lang="ko">
 ...
 <body>
	<div id="container">
		...
		<div class="ct" data-productId="${productId}" data-displayInfoId="${displayInfoId}" data-reservId="${reservInfoId}">
			<div class="ct_wrap">
	...
	<script type="text/javascript" src="./resources/js/pages/reviewWrite/reviewWrite.js"></script>
</body>
</html> 