...
<body>
    <div id="container">
        ...
        <div class="ct" data-dpInfoId = "${displayProductInfoId}">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="./detail?id=${displayProductInfoId}" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                            ...
                            <form class="form_horizontal">
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                    <div class="inline_control"> 
                                    	<input type="text" name="name" id="name" class="text" placeholder="네이버" maxlength="17" data-check = false> 
                                    	<div class="warning_msg">길이 4~17,영문,한글,숫자만 가능해요</div>
                                    </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div class="inline_control tel_wrap">
                                        <input type="tel" name="tel" id="tel" class="tel" value="" placeholder="휴대폰 입력 시 예매내역 문자발송" data-check = false/>
                                ...
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary">필수</span>  <span>이메일</span> </label>
                                    <div class="inline_control"> 
                                    <input type="email" name="email" id="email" class="email" value="" placeholder="crong@codesquad.kr" maxlength="50" data-check = false> 
...
<script type="rv-template" id="head-image">
    <li class="item" style="width: 414px;"> 
		<img alt="" class="img_thumb" src="./productImages/{{id}}"> 
		<span class="img_bg"></span>
        <div class="preview_txt" data-id={{id}}>
         	<h2 class="preview_txt_tit">{{description}}</h2> 
			<em class="preview_txt_dsc">₩{{lowPrice}} ~ {{highPrice}}</em>
			<em class="preview_txt_dsc">2017.2.17.(금)~2017.4.18.(화), 잔여티켓 2769매</em> 
		</div>
     </li>
</script>
<script type="rv-template" id="ticket-body">
	<div class="qty">
    	<div class="count_control">
        <!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
        	<div class="clearfix">
            	<a class="btn_plus_minus spr_book2 ico_minus3 disabled" title="빼기"> </a> <input name="price_cnt" type="tel" class="count_control_input disabled" value="0" data-priceId="{{id}}" readonly title="수량">
        ...
        <!-- [D] 금액이 0 이상이면 individual_price에 on_color 추가 -->
         ...
         <div class="qty_info_icon"> 
            ...
            <strong class="product_price"> 
              	<span class="price">{{priceWithComma}}</span> 
              	<span class="price_type">원</span> 
            </strong> 
            <em class="product_dsc">{{priceWithComma}} ({{discountRate}}% 할인가)</em> 
        </div>
    </div>
</script>                        
	<script type="rv-template" id="displayInfo">
		<h3 class="in_tit">{{description}}</h3>
        <p class="dsc">장소 : {{placeName}}</p>
	...
	<script type="text/javascript" src="./resources/js/pages/reserve/reserve.post.form.js"></script>
	<script type="text/javascript" src="./resources/js/pages/reserve/reserve.display.js"></script>
	<script type="text/javascript" src="./resources/js/pages/reserve/reserve.event.js"></script>
	<script type="text/javascript" src="./resources/js/pages/reserve/reserve.js"></script>
</body>
</html>