...
<body>
    <div id="container">
        ...
        <div class="ct main" data-dpInfoId = "${displayProductInfoId}">
            <div>
                ...
                <div class="section_btn"> <a href = "./reserve?id=${displayProductInfoId}"><button type="button" class="bk_btn"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </a> </div> 
                <div class="section_review_list">
                    ...
                    <a class="btn_review_more" href="./review?id=${displayProductInfoId}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
    ...
    <script type="rv-template" id="content">
		<p class="dsc">{{content}}</p>
	</script>
    
    <script type="rv-template" id="in-content">
			...
			<div>
				<div class="review_area">
					<div class="thumb_area">
						<a class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top"
						src="./{{saveFileName}}" alt="리뷰이미지">
						</a> 
						<span class="img_count" style="display: none;">{{reservationUserCommentImages.length}}</span>
					</div>
				...
				<div class="info_area">
					<div class="review_info">
						<span class="grade">{{score}}</span> <span class="name">{{reservationEmail}}</span> <span class="date">{{createDate}} 방문</span>
					</div>
				</div>
			</div>
		</li>
	...
	<script type="rv-template" id="location">
		<div class="box_store_info no_topline">
			<a class="store_location" title="지도웹으로 연결"> <img class="store_map img_thumb" alt="map"
			src="./displayImages/{{displayInfoId}}"> <span class="img_border"></span> <span class="btn_map"><i
			...
			<div class="lst_store_info_wrap">
				<ul class="lst_store_info">
					...
					</span> <span class="item_rt"> <a href="tel:{{tel}}" class="store_tel">{{tel}}</a></span></li>
				</ul>
			</div>
		</div>
    ...
    <script type="rv-template" id="itemList">
        <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="/productImages/{{productId}}/{{productImageId}}"> <span class="img_bg"></span>
    ...
    <script type="text/javascript" src="./resources/js/pages/detail/detail.js"></script>
</body>
